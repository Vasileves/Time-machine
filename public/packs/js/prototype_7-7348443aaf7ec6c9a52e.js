...
const particlesQuantity = [9];
const positionCell = [[0, 0], [300, 0], [600, 0], [0, 300], [300, 300], [600, 300], [0, 600], [300, 600], [600, 600]]; // [0, 5,3 ]
...
function createCircle(frame) {
  ...
  let cell = Math.floor(getRandomArbitrary(0, 8));

  while (occupated.includes(cell)) {
    cell = Math.floor(getRandomArbitrary(0, 8));
  }
...
/******/ });
//# sourceMappingURL=prototype_7-7348443aaf7ec6c9a52e.js.map