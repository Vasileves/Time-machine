...
function createCircle(frame) {
  ...
  const top = getRandomArbitrary(0, 50);
  const left = getRandomArbitrary(0, 50);
  const size = getRandomArbitrary(100, 120);
  circleElement.style.top = [top, 'vw'].join('');
  circleElement.style.left = [left, 'vw'].join('');
...
/******/ });
//# sourceMappingURL=prototype_5-8aecfeb8c4ccbd5c87c7.js.map