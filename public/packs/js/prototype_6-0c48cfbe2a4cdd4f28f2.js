...
function createCircle(frame) {
  ...
  console.log(circleElement); // console.log(circleType);

  circleElement.classList.add(circleType[0]);
  circleElement.style.transform = "rotate(".concat(getRandomArbitrary(0, 0), "deg)");
...
/******/ });
//# sourceMappingURL=prototype_6-0c48cfbe2a4cdd4f28f2.js.map