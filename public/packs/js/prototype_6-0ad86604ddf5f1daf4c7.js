...
function createCircle(frame) {
  ...
  var top = getRandomArbitrary(0, 1000);
  var left = getRandomArbitrary(0, 1000);
  ...
  circleElement.classList.add(circleType[0]); // circleElement.style.transform = `rotate(${getRandomArbitrary(0, 100)}deg)`
...
/******/ });
//# sourceMappingURL=prototype_6-0ad86604ddf5f1daf4c7.js.map