...
function createCircle(frame) {
  ...
  createEyes(circleElement); // circleElement.style.transform = `rotate(${getRandomArbitrary(10, 350)}deg)`
}

function createEyesBrows(circleElement) {
  const eyes = document.createElement('img');
  eyes.setAttribute('src', `/assets/eyeBrows${Math.floor(getRandomArbitrary(1, 3))}.svg`);
  eyes.classList.add('eyesBrows');
...
/******/ });
//# sourceMappingURL=prototype_7-7a9be35c2da3bc9ac345.js.map